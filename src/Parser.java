...
public class Parser {
    public void parse(/*String path*/) throws Exception {
        try (FileWriter writer = new FileWriter("Output.txt", false)) {
            try (FileReader myFile = new FileReader("C:\\Users\\RUFEZ\\Desktop\\Java_OOP\\OOP_2\\lab_4\\src\\resource\\task.txt")) {
                int read;
                ...
                throw new Exception("Файл C:\\Users\\RUFEZ\\Desktop\\Java_OOP\\OOP_2\\lab_4\\src\\resource\\task.txt не найден");
            }
